...
class Human(db.Model):
    ...
    pets = db.relationship('Animal', backref=db.backref('owner',order_by=human_id))


    def __repr__(self):

        return "<Human human_id={} fname={} lname={} email={}>".format(self.human_id,self.fname,self.lname,
                            self.email)
